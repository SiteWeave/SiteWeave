...
3. **Twilio / carrier compliance**  
   Opt-in SMS includes welcome text, as-needed frequency, Msg&data rates, HELP/STOP, and Terms/Privacy links. Substantive SMS is gated on `sms_phone_consent.status = confirmed` after inbound **YES**. See **[sms-twilio-campaign-registration.md](./sms-twilio-campaign-registration.md)** for copy-paste registration text and screenshot proof checklist.
