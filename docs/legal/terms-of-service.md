...
- Receive optional **transactional SMS** notifications related to assigned project work (subject to Section 18)
...
- Send unsolicited marketing SMS through the Service or use the Service to violate telecommunications laws (including TCPA, CTIA guidelines, and carrier A2P rules)
...
The Service, including software, design, and content, is owned by SiteWeave or its licensors. All rights, title, and interest remain with SiteWeave. These Terms do not grant you any ownership rights.

### 6.2 Trademarks

"SiteWeave" and related marks are trademarks. You may not use our trademarks without prior written permission.

### 6.3 License to Use

We grant you a limited, non-exclusive, non-transferable license to use the Service. This license is for personal or internal business use only. You may not sublicense, sell, or transfer this license.
...
**SMS:** Standard message and data rates from your wireless carrier may apply to text messages you send or receive through the SiteWeave SMS program.
...
We do not warrant that the Service will meet your requirements or be available at all times. We do not guarantee delivery of SMS messages, which depend on carriers and third-party networks.
...
- Your User Content
- Your organization's addition of phone numbers or sending of SMS-related notices without appropriate consent or authority

---

## 12. DATA AND PRIVACY

Your use of the Service is also governed by our Privacy Policy, which is incorporated into these Terms by reference. By using the Service, you consent to the collection and use of information as described in the Privacy Policy, including the SMS/Text Messaging Program section.
...
- You may opt out of SMS by replying **STOP** to our messages
...
Confirmed recipients may receive occasional texts such as task reminders, assignment notices, or project invite links. Frequency depends on project activity; we do not guarantee a maximum or minimum number of messages.

### 18.4 Opt-Out

Reply **STOP** (or STOPALL / UNSUBSCRIBE) to any SiteWeave message to opt out of all SiteWeave SMS to that number. We will send a confirmation that you are unsubscribed. Opting out of SMS does not delete your SiteWeave account.

### 18.5 Help

Reply **HELP** for a short summary of the program and policy links, or email support@siteweave.org.

### 18.6 Organization Users

If you are a project administrator, you agree to:

- Provide phone numbers only for people involved in your projects who reasonably expect operational notifications
- Not use SiteWeave SMS for unsolicited marketing or purchased lead lists
- Comply with applicable telecommunications and privacy laws in your jurisdiction

### 18.7 Policies

- Privacy Policy (SMS section): https://www.siteweave.org/legal/privacy-policy
- Terms of Service (this section): https://www.siteweave.org/legal/terms-of-service
