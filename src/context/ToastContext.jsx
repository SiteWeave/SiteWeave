...
const ToastContainer = ({ toasts, removeToast }) => {
  ...
  const bottomToasts = toasts.filter((toast) => toast.type !== 'error' && toast.placement === 'bottom-center');
  const otherToasts = toasts.filter((toast) => toast.type !== 'error' && toast.placement !== 'bottom-center');
