    ...
    if (!state.authLoading && state.user) {
      ...
      async function fetchInitialData() {
        ...
        try {
          ...
          // Final dispatch with critical data. Do not set tasks/files/calendarEvents/contacts here —
          // tasks/files/calendar are lazy-loaded; contacts arrive via SET_CONTACTS.
          dispatch({ type: 'SET_DATA', payload: { 
            projects: finalProjects, 
